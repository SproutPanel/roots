...
// GetProperties handles GET /api/servers/{uuid}/minecraft/properties
// Returns the parsed server.properties file as JSON
func (h *MinecraftHandlers) GetProperties(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		h.logger.Error("Failed to read server.properties", "error", err)
...
// GetPropertiesWithInfo handles GET /api/servers/{uuid}/minecraft/properties/info
// Returns properties with information about which are managed by Sprout
func (h *MinecraftHandlers) GetPropertiesWithInfo(w http.ResponseWriter, r *http.Request) {
	uuid := chi.URLParam(r, "uuid")
...
// GetWorldInfo handles GET /api/servers/{uuid}/minecraft/world-info
// Returns information about the world folder including datapacks path
func (h *MinecraftHandlers) GetWorldInfo(w http.ResponseWriter, r *http.Request) {
	uuid := chi.URLParam(r, "uuid")
